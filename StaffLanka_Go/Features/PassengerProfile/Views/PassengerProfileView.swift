...
struct PassengerProfileView: View {
    ...
    private var accountSection: some View {
        profileSection(title: "Account") {
            ...
            rowDivider
            profileRow(icon: "arrow.right.square.fill", iconColor: Color.statusDanger, title: "Sign Out", titleColor: .statusDanger, showChevron: false) {
    ...
    private func profileRow(icon: String, iconColor: Color, title: String, titleColor: Color = .textPrimary, showChevron: Bool = true, action: @escaping () -> Void) -> some View {
